...
#.  I use a lot of open source software, I participate in open source development, I like the Free Software Foundation
    ...
    At the end, there is no product on the market that fulfills the priority items on my wish list and features
    open hardware or at least the option to make it more secure by deactivating the black box chips like Intel ME.

I am not particularly interested in USB-C, Thunderbolt or docking stations. However, if these work with the model of my
choice I'm happy. Also USB-C charging is nice to have.
...
The display outer surface is made of aluminium, the inner surface (borders around the display) is made of plastic.
According to Tuxedo this improves WLAN / BT reception.
